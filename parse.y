...
function_definition
    ...
    else
    {
        ...
        set<int> x;
        cout << "CORRECT INSERT IS " << $2->getName() << endl;
        SymbolTableNode2* s = new SymbolTableNode2($2->getName(), x, size_decl_list, 1, paramList, 1);
...
direct_declarator
	...
	$$ = new FuncNode($1->getName(), empty2, empty, args, 0);
