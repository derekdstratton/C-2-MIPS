...
void oneLevelTable() {
    ...
    SymbolTable s;
    pair<string, SymbolTableNode2> item = make_pair("Item 1", SymbolTableNode2());
    pair<string, SymbolTableNode2> item2 = make_pair("Item 2", SymbolTableNode2());
    pair<string, SymbolTableNode2> item3 = make_pair("Item 3", SymbolTableNode2());
    s.insert(item);
    s.insert(item2);
    s.insert(item3);
    cout << s;
...
void multiLevelTable() {
    ...
    pair<string, SymbolTableNode2> item2 = make_pair("Item 2", SymbolTableNode2());
    pair<string, SymbolTableNode2> item3 = make_pair("Item 3", SymbolTableNode2());
    pair<string, SymbolTableNode2> item4 = make_pair("Item 4", SymbolTableNode2());
    s.insert(item);
    s.insert(item2);
    s.pushLevel();
    s.insert(item3);
...
void findOnTopScope() {
    ...
    s.insert(item4);
    cout << s;
    tuple<SymbolTableNode2*, string> ret = s.search("Item 3", true);
    SymbolTableNode2* it;
    string status;
    tie(it, status) = ret;
...
void findOnLowerScope() {
    ...
    s.insert(item4);
    cout << s;
    tuple<SymbolTableNode2*, string> ret = s.search("Item 2");
    SymbolTableNode2* it;
    string status;
    tie(it, status) = ret;
...
void failToFind() {
    ...
    s.insert(item4);
    cout << s;
    tuple<SymbolTableNode2*, string> ret = s.search("Item 5");
    SymbolTableNode2* it;
    string status;
    tie(it, status) = ret;
